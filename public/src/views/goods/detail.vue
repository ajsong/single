...
<div v-if="data">
	...
	<div class="goods-group goods-spec" v-if="data.spec">
		<div class="picView">
			<div>
	...
	<div class="goods-group goods-coupons" v-if="isArray(data.coupons)">
	...
	<div class="goods-group goods-params" v-if="isArray(data.params)">
...
$.fn.photoBrowser = function(options){
	if(typeof options === 'undefined'){
		...
		if(!!this.data('tap'))this.tap(false);
