		...
		*/
		...
		function query($query)
		{
			...
			if ($this->result == false )
			{
				...
				$sqlError = "ErrorCode: ".$errorCode." ### Error Severity: ".$errorSeverity." ### Error Message: ".$errorMessage;

				$this->register_error($sqlError);
				$this->show_errors ? trigger_error(html_entity_decode($sqlError.'<pre>'.$query.'</pre>') ,E_USER_WARNING) : null;
				return false;
			}
