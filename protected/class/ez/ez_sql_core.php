	...
	*/
	...
	class ezSQLcore
	{
		...
		*/
		...
		function get_var($query=null,$param=array(),$x=0,$y=0)
		{
		...
		*/
		...
		function get_row($query=null,$param=array(),$output=OBJECT,$y=0)
		{
		...
		*/
		...
		function get_col($query=null,$param=array(),$x=0)
		{
			...
			for ( $i=0; $i < $j; $i++ )
			{
				$new_array[$i] = $this->get_var(null,$param,$x,$i);
			}
		...
		*/
		...
		function get_results($query=null,$param=array(), $output = OBJECT)
		{
		...
		*/
		...
		function debug($print_to_screen=true)
		{
			...
			if ( $this->last_result )
			{
				...
				$i=0;
				foreach ( $this->get_results(null,$this->param,ARRAY_N) as $one_row )
				{
					$i++;
