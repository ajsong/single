...
class Demo {
	...
	function sendIOSUnicast() {
		try {
			...
			$unicast->setPredefinedKeyValue("timestamp",        $this->timestamp);
			// Set your device tokens here
			$unicast->setPredefinedKeyValue("device_tokens",    "e796d57bc76db35198e77de27b0718812bb84f05639c9b22c30dcf8e5e501501"); 
...
$demo = new Demo("556ffa6c67e58e3cac002645", "uhbe8zdxkxudxdj3eckr0xjwzphtzprn");
$demo->sendIOSUnicast();
